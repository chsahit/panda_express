...
pretrained_model_prompt_cache_dir = "cache-fixme"
...
class PretrainedLargeModel(abc.ABC):
    ...
    def sample_completions(self,
        ...
        os.makedirs(pretrained_model_prompt_cache_dir, exist_ok=True)
        ...
        cache_filepath = os.path.join(pretrained_model_prompt_cache_dir,
                                      cache_foldername, cache_filename)
        if not os.path.exists(cache_filepath):
            llm_use_cache_only = False
            if llm_use_cache_only:
