"""
Improved hand-eye calibration script.
Combines the working data collection workflow from calibrate_hand_eye.py
with the robust calibration logic from calib_demo.py.
"""
...
def calculate_target_to_cam(readings, camera_matrix, dist_coeffs):
    ...
    This is the improved logic from calib_demo.py.
...
try:
    ...
    # ========================================================================
    # Calibration with Outlier Removal (from calib_demo.py)
    # ========================================================================
    ...
    R_cam2gripper, t_cam2gripper = cv2.calibrateHandEye(
        ...
        method=cv2.CALIB_HAND_EYE_TSAI  # Method 4 - can also try PARK, HORAUD, etc.
    )
